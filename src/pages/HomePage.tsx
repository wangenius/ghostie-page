...
import { PiLightning, PiTree, PiGear, PiBrain } from "react-icons/pi";
  ...
  <section className="py-16 relative overflow-hidden">
    <div className="container mx-auto px-4">
      ...
      <div className="flex flex-wrap justify-center items-center gap-8 opacity-50">
        ...
        <img src="/img/partners/shopify.svg" alt="Shopify" className="h-8" />
        <img src="/img/partners/vercel.svg" alt="Vercel" className="h-8" />
        <img src="/img/partners/notion.svg" alt="Notion" className="h-8" />
        <img src="/img/partners/replicate.svg" alt="Replicate" className="h-8" />
      </div>
    </div>
  </section>
);
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        >
          ...
          <p className="text-muted-foreground">
            由定制化模型与前沿模型混合驱动，Ghostie 既聪明又快速。支持多种大语言模型，让您的工作效率倍增。
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-muted-foreground">
            一键导入所有扩展、主题和快捷键绑定。保持您熟悉的工作流程，同时获得 AI 的强大助力。
          </p>
        </motion.div>
  ...
  const philosophies = [
    {
      ...
      title: "深入业务末梢",
      desc: "不止于表层的AI集成，Ghostie深入业务流程的每个环节，解决'最后一公里'的实际问题。"
    },
    {
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          <p className="text-xl font-medium text-muted-foreground">
            让 AI 真正理解您的业务，
            <span className="text-primary font-semibold">成为最懂您的智能伙伴</span>
          </p>
        </motion.div>
      </div>
    </section>

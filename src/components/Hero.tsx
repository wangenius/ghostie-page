...
const Hero = ({
  ...
  const handleDownload = () => {
    ...
    link.href = "/file/ghostie.exe";
    link.setAttribute("download", "ghostie.exe");
  ...
  return (
    <>
      <section className="relative min-h-screen max-h-screen !-mt-14 overflow-hidden bg-gradient-to-b from-background via-background/95 to-muted/30">
          ...
          <div className="container mx-auto px-4 py-24 relative z-10">
            <div className="text-center max-w-5xl mx-auto">
              ...
              >
                ...
                >
                  The Studio for your Agent Crews
                </motion.span>
              </motion.div>
              ...
              >
                Create and manage your personal AI ecosystem, commanding a
                league of agents to efficiently conquer tasks and build your
                ideal team for success.
              </motion.div>
        ...
        <motion.img
          src="/image-black.png"
          alt="Ghostie Platform Interface"

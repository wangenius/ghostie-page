          ...
          <div className="text-center max-w-5xl mx-auto">
            ...
            >
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-4">
                Ghostie
                <br />
                <span className="text-3xl md:text-5xl lg:text-6xl">Desktop Agent Platform</span>
              </h1>
            </motion.div>
            ...
            >
              <a href="https://github.com/wangenius/ghostie-releases">Get Started</a>

              <a className="text-lg font-semibold text-muted-foreground hover:text-primary transition-colors px-8 py-4">
                查看文档
              </a>
            </motion.div>
            ...
            >
              {['多Agent协作', '本地化部署', '插件生态', '工作流引擎', '知识库管理', 'MCP协议'].map(
                (tag, index) => (
                  <span
                    key={index}
